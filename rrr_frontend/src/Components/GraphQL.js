...
export default class GraphQL extends Component {
    ...
    handleChange = (evt) => {
        let value = evt.target.value; // comes from <Input value: "some term" />
    ...
    performSearch() {
        ...
        .then(jsonData => {
            ...
            let theList = Object.values(jsonData.data.search);
            return theList;
        })
        .then(theList => {
            console.log(theList);
    ...
    // construct and send graphql request to backend
    componentDidMount() {
        // "list" matches available graphql field in backend schema
        const payload = `
        {
            list {
                id
        ...
        .then(jsonData => {
            console.log(jsonData);
            let theList = Object.values(jsonData.data.list);
            return theList;
        })
        .then(theList => {
            console.log(theList);
